...
void menu () {
	bio bioskop;
	system ("cls");
	cout << "Christmas Movies tgl 25 December 2020" << endl;
	cout << "#====================================#" << endl;
	...
	system ("cls");
	cout << "-----------------------------------------------------------" << endl;
	cout << "Termia Kasih " << bioskop.nama << " telah memilih menonton di studio ini" << endl;
...
int main () {
		...
		atas:
		menu ();
		cout << "Apakah Anda Memesan Tiket Lagi (y/t)?"; cin >> tanya;
		if (tanya == 'y'){
				goto atas;
		} 
				else {
